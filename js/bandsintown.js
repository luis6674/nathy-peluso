/* ============================================================
   BANDS IN TOWN WIDGET — style patches
   The widget renders its own markup asynchronously and re-renders
   on interaction, so these fixes are re-applied on a timer and
   watched for future DOM changes via MutationObserver.
   ============================================================ */
